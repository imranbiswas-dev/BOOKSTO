...
const Aside = () => {
  const link = (
    <>
      <NavLink className="flex items-center gap-3 ml-2" to="/">
        {" "}
        <AiOutlineHome /> Home
      </NavLink>
      <NavLink className="flex items-center gap-3 ml-2" to="/categories">
        <TbCategory /> Categories
      </NavLink>
      <NavLink className="flex items-center gap-3 ml-2" to="/about">
        <MdOutlineRoundaboutRight /> About
      </NavLink>
      <NavLink className="flex items-center gap-3 ml-2" to="/contact">
        <TbContract /> Contact-Us
      </NavLink>
    </>
  );
  return (
      ...
      <div className="h-full p-3 space-y-2 bg-base-300 w-full ">
        ...
        <div className="divide-y dark:divide-gray-300">
          <ul className="pt-2 pb-4 space-y-1 text-sm">
            {/* NaveLink */}
            <div className="flex flex-col gap-2 md:hidden text-lg mb-4">
              {link}
            </div>
